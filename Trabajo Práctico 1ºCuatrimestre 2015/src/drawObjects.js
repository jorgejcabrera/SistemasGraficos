...
function drawCrame(posX,posY,posZ){
    ...
    //SOPORTE
    drawCube([posX+distanceBeetwenWalls*0.5+(distanceBeetwenWalls*0.5)/5 , posY - longitude * 6 , height + posZ - width],[longitude,distanceBeetwenWalls * 1.5,width*1.5]);
   	drawCube([posX+distanceBeetwenWalls*0.5-(distanceBeetwenWalls*0.5)/5 , posY - longitude * 6 , height + posZ - width],[longitude,distanceBeetwenWalls * 1.5,width*1.5]);
...
function drawCabin(posX,posY,posZ,height){
	...
	//PINZAS IZQUIERDAS
	drawPinza([posXRearWall-longitudeRearWall+width, posYRearWall-longitudeRearWall*0.75-width-width*6,posZ-height+width],[width*0.25,width*0.25,posZ*scaleDeLasPinzas]);	//El +2 es porque antes media desde otro lado a otro lado
	drawPinza([posXRearWall-longitudeRearWall+width, posYRearWall-longitudeRearWall*0.75-width+width*6,posZ-height+width],[width*0.25,width*0.25,posZ*scaleDeLasPinzas]);	//El +2 es porque antes media desde otro lado a otro lado
